...
public class BtcAddressGen {
    ...
    private static final Logger log = LogManager.getLogger(BtcAddressGen.class.getName());

    public static void genBitcoinAddress(String publicKey)
        ...
        log.info("BTC Address: " + encodeBase58(binaryAddress));
    }
